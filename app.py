...
# Removed duplicated Analysis tabs block (motion/clustering/dwell/boundary/multichannel/advanced) to fix indentation error and prevent NameError for undefined 'tabs' outside original Analysis page.
